...
Class Proforma
{
  ...
  public function insertar($idusuario,$idcliente,$correlativo,$referencia,$fecha_hora,$validez,$tiempoEntrega,$idarticulo,$cantidad,$precio_venta,$serieProforma,$total_venta,$igv_total,$igv_asig){
    ...
    $sql="INSERT INTO proforma (idusuario,idcliente,correlativo,referencia,fecha_hora,estado,validez,tiempoEntrega,serie,total_venta,igv_total,igv_asig) VALUES ('$idusuario','$idcliente','$correlativo','$referencia','$fecha_hora','AceptadoP','$validez','$tiempoEntrega','$serie','$total_venta','$igv_total','$igv_asig')";
    ...
    while ($num_elementos<count($idarticulo)) {
     ...
     {
      $sql_detalle = "INSERT INTO detalle_proforma(idproforma,idarticulo,cantidad,precio_venta,serie) VALUES ('$idproformanew','$idarticulo[$num_elementos]','$cantidad[$num_elementos]','$precio_venta[$num_elementos]','$serieProforma[$num_elementos]')";
