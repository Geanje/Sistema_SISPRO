          ...
          <div class="col-md-12">
            <div class="box">
              <div class="box-header with-border">
                <h1 class="box-title">Consulta total de vetas mensual &nbsp;&nbsp;&nbsp;
                  <a target="_blank" href="../reportes/report_venta_mensual.php"> <button class="btn btn-warning btn-art"><i class="fa fa-file-pdf-o"></i> &nbsp;Reporte</button> </a>
                </h1>
              ...
              <div class="panel-body table-responsive" id="listadoregistros">
                ...
                <div class="form-group col-lg-2 col-md-4 col-sm-6 col-xs-12">
                  ...
                  <select class="form-control selectpicker" name="modulo" id="modulo" required>
                    <option value="0" id="">Todos</option>
                    <option value="1" id="">Venta</option>
                    <option value="2" id="">Servicio</option>
                  </select>
                </div>
