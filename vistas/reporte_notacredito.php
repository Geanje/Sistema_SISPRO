          ...
          <div class="col-md-12">
            <div class="box">
              <div class="box-header with-border">
                <h1 class="box-title">Reporte Nota de Credito &nbsp;&nbsp;&nbsp;
                  <a target="_blank" href="../reportes/report_notacredito.php"> <button class="btn btn-warning btn-art"><i class="fa fa-file-pdf-o"></i> &nbsp;&nbsp;&nbsp;PDF</button> </a>
                </h1>
