          ...
          <div class="col-md-12">
            <div class="box">
              <div class="box-header with-border">
                <h1 class="box-title">Consulta total de pagos mensual S.T &nbsp;&nbsp;&nbsp;&nbsp;
                  <a target="_blank" href="../reportes/rpt_sp_mensual.php"> <button class="btn btn-warning btn-art"><i class="fa fa-file-pdf-o"></i> &nbsp; Reporte</button> </a>
                </h1>
