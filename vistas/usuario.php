          ...
          <div class="col-md-12">
            <div class="box">
              <div class="box-header with-border">
                ...
                <a target="_blank" href="../reportes/usuariopdf.php"> <button class="btn btn-warning btn-art" id="btnPDF"><i class="fa fa-file-pdf-o"></i> &nbsp;PDF</button> </a>
              ...
              <div class="panel-body" id="formularioregistros">
                <form name="formulario" id="formulario" method="POST">
                  ...
                  <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    ...
                    <img src="" id="imagenmuestra" style="max-width: 250px; max-height: 250px; margin-left: 20px; margin-top: 30px;">
                  </div>
                  <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
