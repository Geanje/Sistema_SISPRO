          ...
          <div class="col-md-12">
            <div class="box">
              <div class="box-header with-border">
                <h1 class="box-title">Facturacion por Servicio con IGV &nbsp;&nbsp;<button class="btn btn-success" id="btnagregar" onclick="informe()"><i class="fa fa-plus-circle"></i>&nbsp;&nbsp;Agregar</button></h1>
              ...
              <div class="panel-body table-responsive" id="listadoregistros">
                <table id="tbllistado" class="table table-striped table-bordered table-condensed table-hover">
                  <input type="hidden" name="listado" id="listado" value="1">
                  <thead>
                    <th>Opciones</th>
                    <th>Fecha</th>
                    <th>Cliente</th>
              ...
              <div class="panel-body" id="formularioregistros">
                <form name="formulario" id="formulario" method="POST">
                  ...
                  <div class="form-group col-lg-1 col-md-2 col-sm-2 col-xs-12">
                    ...
                    <input type="hidden" name="ivg" id="ivg" value="1">
                  </div>
