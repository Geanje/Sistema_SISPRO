                   ...
                   <div class="box">
                     <div class="box-header with-border">
                           <h1 class="box-title">Proveedor&nbsp;&nbsp;<button id="agregarProveedor" class="btn btn-success"
                             ...
                             <button class="btn btn-warning btn-art" id="btnreporte"><i class="fa fa-file-pdf-o"></i> &nbsp;<a target="_blank" href="../reportes/rptpersona.php" style="color: white">Reporte</button></a>
