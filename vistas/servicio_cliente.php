          ...
          <div class="col-md-12">
            <div class="box">
              <div class="box-header with-border">
                <h1 class="box-title">Cliente&nbsp;&nbsp;&nbsp;&nbsp;<button id="agregarCliente" class="btn btn-success" onclick="mostrarform(true)">
                    <i class="fa fa-plus-circle"></i> &nbsp;&nbsp;Agregar</button>
                  <a target="_blank" href="../reportes/servicio_clientepdf.php"> <button class="btn btn-warning btn-art" id="btnPDF"><i class="fa fa-file-pdf-o"></i> &nbsp;PDF</button> </a>
                </h1>
