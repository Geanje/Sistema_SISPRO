		...
		<table class="articulo" border="0.3" cellpadding="0" cellspacing="1" bordercolor="black" style="border-collapse:collapse;">
			...
			?>
				...
				<tr style="text-align:left">
					<td style="background-color: <?php echo $estilo; ?>;; width:9.05%; padding-top: 5px; text-align: center;"><?php echo $regd->codigo;  ?></td>
					<td style="background-color: <?php echo $estilo; ?>;; width:55%; height: 1.12px; padding-top: 5px; text-align: justify; padding: 5px" rowspan="&"><?php echo $regd->articulo . " " . $regd->serie; ?></td>
