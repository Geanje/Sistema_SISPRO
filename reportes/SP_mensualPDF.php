...
<body>
        ...
        <table>
            <tr>
                ...
                <td style="width: 45%; text-align: center"> <br>
                    <h4 align="center">REGISTRO DE PAGOS MENSUALES</h4>
                </td>
    ...
    <table border="1" cellpadding="1" cellspacing="1" style="width: 100%; padding-left: 5px; font-size:10">
        <tr style="text-align: center">
            <th style=" width: 65; height: 30">FECHA</th>
            <th width="280">CLIENTE</th>
            <th width="90">DOCUMENTO</th>
            <th width="80">PAGO</th>
            <th width="60">CUOTA</th>
            <th width="60">SALDO</th>
            <th width="70">ESTADO</th>
        </tr>
        <?php
        $json_data = file_get_contents('../reportes/temp_rptjson/soporte_pago_mensual.json');
        ...
        foreach ($data as $item) {
            echo '<tr>';
            echo '<td width="65" height="10">' . $item['0'] . '</td>';
            echo '<td width="280" align="center" >' . $item['1'] . '</td>';
