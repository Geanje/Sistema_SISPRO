...
<body>
        ...
        <table>
            <tr>
                ...
                <td style="width: 45%; text-align: center"> <br>
                    <h4 align="center">CONSULTA DE REPORTE MENSUAL CONTABLE </h4>
                </td>
    ...
    <table border="1" cellpadding="1" cellspacing="1" style="width: 100%; padding-left: 5px; font-size: 10px;">
        <tr style="text-align: center">
            ...
            <th width="90">N° DOCUMENTO</th>
            <th width="100">COMPROBANTE</th>
            <th width="110">N° COMPROBANTE</th>
            <th width="60">TOTAL</th>
            <th width="60">TIPO P.</th>
            <th width="60">ESTADO</th>
        </tr>
        <?php
        $json_data = file_get_contents('../reportes/temp_rptjson/consultas-contable.json');
        ...
        foreach ($data as $item) {
            ...
            echo '<td width="175" align="center" >' . $item['1'] . '</td>';
