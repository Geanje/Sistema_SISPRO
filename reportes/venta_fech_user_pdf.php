...
<body>
        ...
        <table>
            <tr>
                ...
                <td style="width: 45%; text-align: center"> <br>
                    <h4 align="center">VENTAS POR USUARIO</h4>
                </td>
    ...
    <table border="1" cellpadding="1" cellspacing="1" style="width: 100%; padding-left: 5px; font-size: 10px;">
        <tr style="text-align: center">
            <th style=" width: 60; height: 30">FECHA</th>
            <th width="290">CLIENTE</th>
            <th width="70">N° DOC.</th>
            <th width="105">COMPROBANTE</th>
            <th width="50">VENTA</th>
            <th width="70">TIPO PAGO</th>
            <th width="50">ESTADO</th>
        </tr>
        <?php
        $json_data = file_get_contents('../reportes/temp_rptjson/ventasFechaUsuario.json');
        ...
        foreach ($data as $item) {
            ...
            echo '<td width="290" align="center" >' . $item['1'] . '</td>';
            echo '<td width="60" align="center">' . $item['2'] . '</td>';
            echo '<td width="80" align="center">' . $item['3'] . '</td>';
            echo '<td width="50" align="center">' . $item['5'] . '</td>';
            echo '<td width="70" align="center">' . $item['6'] . '</td>';
