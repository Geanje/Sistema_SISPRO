...
<body>
        ...
        <table>
            <tr>
                ...
                <td style="width: 45%; text-align: center"> <br>
                    <h4 align="center">CONSULTAS DE VENTAS POR CLIENTE</h4>
                </td>
    ...
    <table border="1" cellpadding="1" cellspacing="1" style="width: 100%; padding-left: 5px; font-size: 10px;">
        <tr style="text-align: center">
            ...
            <th width="100">N° COMPROBANTE</th>
            <th width="40">VENTA</th>
            <th width="30">IVG</th>
            <th width="60">ESTADO</th>
        </tr>
        <?php
        $json_data = file_get_contents('../reportes/temp_rptjson/ventasfechacliente.json');
