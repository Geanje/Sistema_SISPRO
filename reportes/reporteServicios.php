...
<body>
  ...
  <page_footer>
    <table>
      <tr class="">
        <td><img style="width: 760px;height: 140px;" src="../files/perfil/footer.png"></td>
      </tr>
    </table>
  </page_footer>
  ...
  <div class="cliente">
    ...
    <table>
      <tr style="width: 100%;">
        ...
        <!--<td style="width: 30%;">: <?php setlocale(LC_ALL, "es_ES");
                                      echo strftime("%d de %B del %Y"); ?></td>-->
      </tr>
    </table>
    <table>
      <tr style="width: 100%;">
  ...
  <div class="cliente">
    <table style="width: 98%;">
      ...
      <tr style="width: 100%;">
        <td style="width: 5%"></td>
        <td style="width: 28%; height: 5px; text-align:center">
          <hr style="border: 0.3px dotted #087DA2; width:300px" />
        </td>
        <td style="width: 25%"></td>
